          ...
          <div className="row g-5">
            <div className="col-md-6 col-lg-6 col-xl-4">
              <div className="footer-item">
                <Link to="/" className="p-0 d-flex align-items-center mb-4">
                  <img 
                    src={keansburgLogo} 
                    alt="Keansburg Logo" 
                    className="me-2"
                ...
                <p className="mb-3 text-white-50">Text</p>
                <p className="mb-3 text-white-50">Text</p>
                <p className="mb-4 text-white-50">Text</p>
            ...
            <div className="col-md-6 col-lg-6 col-xl-2">
              <div className="footer-item">
                ...
                <div className="d-flex flex-column">
                  ...
                  <Link to="/attractions" className="text-white-50 mb-2 text-decoration-none">
                    <i className="fas fa-angle-right me-2" style={{ color: '#3CBEEE' }}></i> Attractions
                  </Link>
